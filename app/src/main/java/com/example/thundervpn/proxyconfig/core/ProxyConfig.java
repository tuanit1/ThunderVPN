...
import com.example.thundervpn.BuildConfig;
...
public class ProxyConfig {
    ...
    public static String getHttpProxyServer(Context ctx) {
        return ctx.getSharedPreferences("current_proxy", Context.MODE_PRIVATE)
    ...
    public Config getDefaultProxy() {
        if (m_ProxyList.isEmpty()) {
            return HttpConnectConfig.parse("192.168.2.10", 1082, "user1", "pass1");
        } else {
